...
interface ContractAbiInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: 'buy_seeds',
    values: [FoodTypeInput, BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'buy_seeds_free',
    values: [FoodTypeInput, BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'can_level_up',
    values: [IdentityInput]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'get_garden_vec',
    values: [IdentityInput]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'get_item_amount',
    values: [IdentityInput, FoodTypeInput]
  ): Uint8Array;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'get_seed_amount',
    values: [IdentityInput, FoodTypeInput]
  ): Uint8Array;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'plant_seed_at_index',
    values: [FoodTypeInput, BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'plant_seeds',
    values: [FoodTypeInput, BigNumberish, Vec<BigNumberish>]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'sell_item',
    values: [FoodTypeInput, BigNumberish]
  ): Uint8Array;
...
export class ContractAbi extends Contract {
  ...
  functions: {
    ...
    plant_seed_at_index: InvokeFunction<
      ...
      void
    >;
    plant_seeds: InvokeFunction<
      [
        food_type: FoodTypeInput,
        amount: BigNumberish,
        indexes: Vec<BigNumberish>,
      ],
      void
    >;
